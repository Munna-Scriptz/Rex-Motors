...
const MiddleBanner = () => {
    return (
        <>
            <main id='Middle-Banner' className='md:mt-[112px] mt-[80px] relative h-[560px] overflow-hidden'>
                <div className="container">
                    <div id="Middle-Banner-Row" className='relative rounded-[12px] flex items-center justify-center h-[500px] w-full bg-cover overflow-hidden' style={{ backgroundImage: `url(${midBan})` }} data-aos="fade-up">
                        {/* ----------- Label  */}
                        <div className='bg-white absolute top-12 -left-2 rounded-[12px] md:w-[340px] w-[240px]' data-aos="fade-right">
                            <h2 className='px-6 py-2 text-brand font-bold md:text-2xl text-base md:pl-15 pl-8' data-aos="fade-right">Mercedes EQS Sedan</h2>
                        </div>
                ...
                <section className='absolute lg:w-[850px] w-full lg:left-1/5 mx-auto bottom-0 py-3'>
                    <div className="container">
                        <div id="SearchFilter-row" className='bg-transparent px-5 py-3 rounded-[12px] shadow-md' data-aos="fade-up">

                            {/* ----------------- Information --------------------- */}
                            <div className='flex lg:flex-nowrap flex-wrap gap-y-5 items-center justify-between' >
                                <div className='flex items-center gap-4 text-white' data-aos="fade-up">
                            ...
                            {/* ---------------- Link --------------------- */}
                            <div className='flex items-center justify-center mt-7' data-aos="fade-up">
            ...
            <section className='mt-12 md:mt-[80px]'>
                <div className="container">
                    <div id='Discover-Row' className='flex flex-col md:flex-row items-stretch md:items-center gap-4'>
                        <Link to={'/'} className='bg-brand py-4 px-4 w-full md:w-1/2 rounded-[8px] flex items-center justify-between cursor-pointer hover:-translate-y-3 duration-300' data-aos="fade-right">
                            <div>
                        ...
                        <Link to={'/'} className='bg-brand py-4 px-4 w-full md:w-1/2 rounded-[8px] flex items-center justify-between cursor-pointer hover:-translate-y-3 duration-300' data-aos="fade-left">
                            <div>
