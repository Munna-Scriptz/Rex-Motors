  ...
  return (
    <div className='md:w-[360px] w-full mx-auto rounded-[24px] py-6 px-6 border-1 border-[#D8D8D8]'>
        ...
        <div className='relative '>
            <img className='rounded-[12px]' src={car} alt="Car image" />
            ...
            <div className='absolute left-[15px] top-[15px] w-[120px] bg-[#3D923A] px-3 py-1.5 rounded-[8px] flex items-center gap-2'>
                ...
                <p className='text-white font-bold text-xs'>Great Price</p>
            </div>
        ...
        <div className='mt-7 border-b pb-2 border-[#E9E9E9]'>
            <h2 className='text-[#050B20] text-xl font-semibold mt-4 w-[340px]'>T-Cross - 2023</h2>
            <p className='text-second text-base w-[340px]'>4.0 D5 PowerPulse Momentum 5dr</p>
        </div>
        ...
        <div className='mt-7 border-b pb-2 border-[#E9E9E9] flex items-center justify-between'>
            <div className='flex items-center justify-center flex-col gap-2'>
                ...
                <p className='text-primary'>1500 Miles</p>
            </div>
            <div className='flex items-center justify-center flex-col gap-2'>
                <BsFuelPumpDiesel className='text-[26px]' />
                <p className='text-primary'>Diesel</p>
            </div>
            <div className='flex items-center justify-center flex-col gap-2'>
                <PiPathDuotone className='text-[26px]' />
                <p className='text-primary'>CVT</p>
            </div>
        </div>

        {/* -------------------- Price  */}
        <div className='mt-6 flex items-center justify-between'>
            <h2 className='text-[#3D923A] text-xl font-bold'>$82,000</h2>
