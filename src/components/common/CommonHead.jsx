...
const CommonHead = ({text , linkName}) => {
  return (
    <div className='flex flex-wrap gap-y-3 items-center justify-between'>
        <div className='flex items-center md:gap-5.5 gap-2.5'>
        ...
        {/* --------------- View All  */}
        <Link className='text-second flex items-center gap-2.5 font-bold' to={'/'}>{linkName} <div className='w-[24px] h-[24px] bg-brand text-white rounded-full flex items-center justify-center text-lg'><MdArrowOutward /></div></Link>
    </div>
  )
}
